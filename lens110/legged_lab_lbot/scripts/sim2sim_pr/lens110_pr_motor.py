...
"""Compact MuJoCo sim2sim runner for Lens110 motor-actuator XMLs.
...
DEFAULT_CONFIG = os.path.join(os.path.dirname(__file__), "pr_motor.json")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Compact Lens110 motor-XML MuJoCo sim2sim runner.")
    ...
    parser.add_argument("--output", default="simulation_motor.mp4")
