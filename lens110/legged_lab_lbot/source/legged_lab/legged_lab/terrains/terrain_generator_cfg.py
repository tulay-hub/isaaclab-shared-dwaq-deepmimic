...
from .custom_terrains import (
    Lens110RandomInvertedPyramidStairsTerrainCfg,
    Lens110RandomLoopTerrainCfg,
    Lens110RandomPyramidStairsTerrainCfg,
)
...
# LENS110 keeps the original DWAQ terrain proportions, but samples terrain
# types and 5-25 cm stair risers independently without a terrain curriculum.
LENS110_RANDOM_DWAQ_TERRAINS_CFG = copy.deepcopy(DWAQ_TERRAINS_CFG)
LENS110_RANDOM_DWAQ_TERRAINS_CFG.curriculum = False
LENS110_RANDOM_DWAQ_TERRAINS_CFG.sub_terrains = dict(DWAQ_TERRAINS_CFG.sub_terrains)
for _name in ("stairs_up_26", "stairs_up_30", "stairs_up_34"):
    _source = DWAQ_TERRAINS_CFG.sub_terrains[_name]
    LENS110_RANDOM_DWAQ_TERRAINS_CFG.sub_terrains[_name] = Lens110RandomPyramidStairsTerrainCfg(
        proportion=_source.proportion,
        step_height_range=(0.05, 0.25),
        step_width=_source.step_width,
        platform_width=_source.platform_width,
        border_width=_source.border_width,
        holes=_source.holes,
    )
for _name in ("stairs_down_26", "stairs_down_30", "stairs_down_34"):
    _source = DWAQ_TERRAINS_CFG.sub_terrains[_name]
    LENS110_RANDOM_DWAQ_TERRAINS_CFG.sub_terrains[_name] = Lens110RandomInvertedPyramidStairsTerrainCfg(
        proportion=_source.proportion,
        step_height_range=(0.05, 0.25),
        step_width=_source.step_width,
        platform_width=_source.platform_width,
...
# ------------------------------------------------------------------ #
#  LENS110: randomized grouped stairs -> descent -> rough terrain      #
# ------------------------------------------------------------------ #

LENS110_RANDOM_STAIRS_ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    curriculum=True,
    size=(20.0, 8.0),
    border_width=1.0,
    num_rows=6,
    ...
    use_cache=False,
    sub_terrains={
        "lens110_random_loop": Lens110RandomLoopTerrainCfg(proportion=1.0),
    },
)
