...
@configclass
class Lens110DwaqRunnerCfg(RslRlOnPolicyRunnerCfg):
    """RSL-RL runner configuration for LENS110 DWAQ blind walking."""

    class_name = "DWAQRunner"
    num_steps_per_env = 24
    max_iterations = 10000
    save_interval = 100
    experiment_name = "lens110_dwaq"
