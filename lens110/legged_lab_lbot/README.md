...
./isaaclab.sh -p scripts/rsl_rl/train.py --task LeggedLab-Isaac--Deepmimic-G1-v0 --headless --max_iterations 2000
...
./isaaclab.sh -p scripts/rsl_rl/play.py --task LeggedLab-Isaac--Deepmimic-Lens110-v0 --num_envs 8 --checkpoint logs/rsl_rl/lens110_deepmimic/2026-07-30_10-02-33/model_2000.pt 
...
./isaaclab.sh -p scripts/rsl_rl/train.py --task LeggedLab-Isaac-AMP-G1-v0 --headless --max_iterations 2000
./isaaclab.sh -p scripts/rsl_rl/train.py --task LeggedLab-Isaac-AMP-Lens110-v0 --headless --max_iterations 2000
