...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # 新版 rsl_rl 的观测归一化器挂在 policy 上, 不再使用 runner.obs_normalizer
    ...
    if os.path.exists(onnx_file):
        ...
        except (subprocess.CalledProcessError, FileNotFoundError, ModuleNotFoundError) as err:
            print(f"[WARN] MNN 转换跳过/失败 (不影响 Isaac 播放): {err}")
    else:
